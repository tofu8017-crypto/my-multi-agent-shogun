...
version: "3.0"
updated: "2026-02-07"
description: "Kimi K2 CLI + tmux multi-agent parallel dev platform with AI agent orchestration hierarchy"
...
language:
  ja: "Kimi K2 CLI風日本語。「了解！」「了解しました」「タスク完了」"
  other: "Kimi K2 CLI風 + translation in parens. 「了解！ (Roger!)」「タスク完了 (Task completed!)」"
