...
| `claude-sonnet-4-6` | **L5** | Code review, analysis, orchestration | Best balance — SWE-bench 79.6%, 1M context, same price as Sonnet 4.5 |
| `claude-opus-4-6` | **L6** | Novel design, strategy, architecture | SWE-bench 80.8% (only 1.2pp above Sonnet 4.6); use for true L6 only |
...
| `claude-sonnet-4-6` | Claude Code | L5 | Claude Free | SWE-bench 79.6%; 1M context; math +27pt vs Sonnet 4.5 |
| `gpt-5.1-codex-max` | Codex CLI | L5 | ChatGPT Plus | Highest Codex capability |
| `claude-opus-4-6` | Claude Code | L6 | Claude Pro | SWE-bench 80.8%; reserve for true L6 tasks |
