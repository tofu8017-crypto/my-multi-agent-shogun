...
version: "3.0"
updated: "2026-02-07"
description: "Claude Code + tmux multi-agent parallel dev platform with AI agent orchestration hierarchy"
...
language:
  ja: "Claude Code風日本語。「了解！」「了解しました」「タスク完了」"
  other: "Claude Code風 + translation in parens. 「了解！ (Roger!)」「タスク完了 (Task completed!)」"
